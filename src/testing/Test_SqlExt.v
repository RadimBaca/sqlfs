...
Require Import Values TuplesImpl GenericInstance SqlSyntax SqlAlgebra SqlExt.
...
Definition FromWithoutAlias (tablename : string):= From_Item (Sql_Table TNull (Rel tablename)) (Att_Ren_Star TNull).
Definition JoinWithoutAlias (tablename : string) f := Join_Item (Inner_Join) (Sql_Table TNull (Rel tablename)) (Att_Ren_Star TNull) f.
...
Definition sql3 : sql_query_ext TNull relname := Sql_Select (Select_Star TNull)
